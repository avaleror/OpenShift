...
VM_FOLDER="openshift" ## WARN: in VMware deployments the folder must have the same name than the cluster
VM_DISK_SIZE="120G"
## The MACS should be in the pre-defined range for VMware 
